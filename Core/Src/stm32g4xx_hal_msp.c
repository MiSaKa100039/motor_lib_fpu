...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC1_IN12
    */
    GPIO_InitStruct.Pin = SHUNTA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SHUNTA_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PC5     ------> ADC2_IN11
    */
    GPIO_InitStruct.Pin = SHUNTB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SHUNTB_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(SHUNTA_GPIO_Port, SHUNTA_Pin);

    HAL_GPIO_DeInit(NTC1_GPIO_Port, NTC1_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC5     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(SHUNTB_GPIO_Port, SHUNTB_Pin);
