...
#warning Not supported compiler type
    ...
    { /*!< (@ 0x48000A00) GPIOF Structure*/
        ...
        union
        {
            union
            {
                __IOM uint32_t PU_SEL; /*!< (@ 0x0000003C) GPIO port Selection of pull-up resistor*/
                ...
                struct
                {
                    ...
                    __IOM uint32_t BS14 : 1; /*!< [14..14] BS14*/
                    __IOM uint32_t BS15 : 1; /*!< [15..15] BS15*/
                    __IOM uint32_t PS0 : 1;  /*!< [16..16] PS0 */
                    __IOM uint32_t PS1 : 1;  /*!< [17..17] PS1 */
                    __IOM uint32_t PS2 : 1;  /*!< [18..18] PS2 */
                    __IOM uint32_t PS3 : 1;  /*!< [19..19] PS3 */
                    __IOM uint32_t PS4 : 1;  /*!< [20..20] PS4 */
                    __IOM uint32_t PS5 : 1;  /*!< [21..21] PS5 */
                    __IOM uint32_t PS6 : 1;  /*!< [22..22] PS6 */
                    __IOM uint32_t PS7 : 1;  /*!< [23..23] PS7 */
                    __IOM uint32_t PS8 : 1;  /*!< [24..24] PS8 */
                    __IOM uint32_t PS9 : 1;  /*!< [25..25] PS9 */
                    __IOM uint32_t PS10 : 1; /*!< [26..26] PS10*/
                    __IOM uint32_t PS11 : 1; /*!< [27..27] PS11*/
                    __IOM uint32_t PS12 : 1; /*!< [28..28] PS12*/
                    __IOM uint32_t PS13 : 1; /*!< [29..29] PS13*/
                    __IOM uint32_t PS14 : 1; /*!< [30..30] PS14*/
                    __IOM uint32_t PS15 : 1; /*!< [31..31] PS15*/
                } PU_SEL_b;
            };

            union
            {
                __IM uint32_t PUS; /*!< (@ 0x0000003C) return GPIO port Pull up resistor selection configuration bit status when read    */

                struct
                {
                    __IM uint32_t PU0 : 1;  /*!< [0..0] PU0   */
                    __IM uint32_t PU1 : 1;  /*!< [1..1] PU1   */
                    __IM uint32_t PU2 : 1;  /*!< [2..2] PU2   */
                    __IM uint32_t PU3 : 1;  /*!< [3..3] PU3   */
                    __IM uint32_t PU4 : 1;  /*!< [4..4] PU4   */
                    __IM uint32_t PU5 : 1;  /*!< [5..5] PU5   */
                    __IM uint32_t PU6 : 1;  /*!< [6..6] PU6   */
                    __IM uint32_t PU7 : 1;  /*!< [7..7] PU7   */
                    __IM uint32_t PU8 : 1;  /*!< [8..8] PU8   */
                    __IM uint32_t PU9 : 1;  /*!< [9..9] PU9   */
                    __IM uint32_t PU10 : 1; /*!< [10..10] PU10*/
                    __IM uint32_t PU11 : 1; /*!< [11..11] PU11*/
                    __IM uint32_t PU12 : 1; /*!< [12..12] PU12*/
                    __IM uint32_t PU13 : 1; /*!< [13..13] PU13*/
                    __IM uint32_t PU14 : 1; /*!< [14..14] PU14*/
                    __IM uint32_t PU15 : 1; /*!< [15..15] PU15*/
                } PUS_b;
            };
        };
