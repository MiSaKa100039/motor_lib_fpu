...
{
    CRCx->CRC_CTRL |= CRC_GPS_CRC8 | CRC_BYTE_1 | CRC_RESET_CRC_EN | CRC_RESET_OFF | CRC_SWAP_00;
}

void Crc_initial_config_16a(CRC_TypeDef *CRCx)
{
    CRCx->CRC_CTRL = CRC_GPS_CRC16a | CRC_LM_MSB | CRC_BYTE_2 | CRC_RESET_CRC_EN | CRC_RESET_OFF | CRC_SWAP_01;
}

void Crc_initial_config_16b(CRC_TypeDef *CRCx)
{
    CRCx->CRC_CTRL = CRC_GPS_CRC16b | CRC_LM_MSB | CRC_BYTE_2 | CRC_RESET_CRC_EN | CRC_RESET_OFF | CRC_SWAP_01;
}

void Crc_initial_config_32(CRC_TypeDef *CRCx)
{
    CRCx->CRC_CTRL = CRC_GPS_CRC32 | CRC_LM_MSB | CRC_BYTE_4 | CRC_RESET_CRC_EN | CRC_RESET_OFF | CRC_SWAP_11;
}
