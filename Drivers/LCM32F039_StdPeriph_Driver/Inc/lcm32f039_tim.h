...
#define TIM1_IntputSource_TIM3_TRGO         ((uint32_t)0x00000001)
...
#define TIM1_IntputSource_TIM2_OC1_TRIG     ((uint32_t)0x00000006)
...
#define IS_TIM1_IntputSource(INx) ((INx == TIM1_IntputSource_IO) ||             \
                                   ...
                                   (INx == TIM1_IntputSource_TIM3_TRGO) ||      \
                                   ...
                                   (INx == TIM1_IntputSource_TIM2_OC1_TRIG) ||  \
...
#define TIM2_IntputSource_TIM3_TRGO         ((uint32_t)0x00000001)
...
#define TIM2_IntputSource_TIM1_OC1_TRIG     ((uint32_t)0x00000005)
#define TIM2_IntputSource_TIM15_OC1_TRIG    ((uint32_t)0x00000006)
#define TIM2_IntputSource_TIM16_OC1_TRIG    ((uint32_t)0x00000007)
#define IS_TIM2_IntputSource(INx) ((INx == TIM2_IntputSource_IO) ||             \
                                   (INx == TIM2_IntputSource_TIM3_TRGO) ||      \
                                   ...
                                   (INx == TIM2_IntputSource_TIM1_OC1_TRIG) || \
                                   (INx == TIM2_IntputSource_TIM15_OC1_TRIG) ||  \
                                   (INx == TIM2_IntputSource_TIM16_OC1_TRIG))
...
#define TIM3_IntputSource_TIM2_TRGO         ((uint32_t)0x00000001)
...
#define IS_TIM3_IntputSource(INx) ((INx == TIM3_IntputSource_IO) ||             \
                                   (INx == TIM3_IntputSource_TIM2_TRGO) ||      \
...
#define TIM15_IntputSource_TIM3_TRGO        ((uint32_t)0x00000001)
...
#define TIM15_IntputSource_TIM2_OC1_TRIG    ((uint32_t)0x00000006)
...
#define IS_TIM15_IntputSource(INx) ((INx == TIM15_IntputSource_IO) ||            \
                                    ...
                                    (INx == TIM15_IntputSource_TIM3_TRGO) ||     \
                                    ...
                                    (INx == TIM15_IntputSource_TIM2_OC1_TRIG) || \
...
#define TIM16_IntputSource_TIM3_TRGO        ((uint32_t)0x00000001)
...
#define TIM16_IntputSource_TIM2_TRGO        ((uint32_t)0x00000006)
...
#define TIM17_IntputSource_TIM3_TRGO        ((uint32_t)0x00000001)
...
#define TIM17_IntputSource_TIM2_TRGO        ((uint32_t)0x00000006)
...
#define TIM1_Break1Source_TIM2_TRGO         ((uint32_t)0x00000800)
...
#define TIM2_Break1Source_TIM15_TRGO      ((uint32_t)0x00000800)
#define TIM2_Break1Source_TIM1_TRGO       ((uint32_t)0x00001000)
...
// TIM3 break1
#define TIM3_Break1Source_ACMP0_OUTPUT    ((uint32_t)0x01000000)
#define TIM3_Break1Source_ACMP1_OUTPUT    ((uint32_t)0x02000000)
#define TIM3_Break1Source_ACMP2_OUTPUT    ((uint32_t)0x04000000)
#define TIM3_Break1Source_TIM15_TRGO      ((uint32_t)0x08000000)
#define TIM3_Break1Source_TIM1_TRGO       ((uint32_t)0x10000000)
#define TIM3_Break1Source_AWD             ((uint32_t)0x20000000)
#define TIM3_Break1Source_IO              ((uint32_t)0x40000000)
#define IS_TIM3_BreakSource(Source) ((Source == TIM3_Break1Source_ACMP0_OUTPUT) ||    \
                                     (Source == TIM3_Break1Source_ACMP1_OUTPUT) ||    \
                                     (Source == TIM3_Break1Source_ACMP2_OUTPUT) ||    \
                                     (Source == TIM3_Break1Source_TIM1_TRGO) ||       \
                                     (Source == TIM3_Break1Source_TIM15_TRGO) ||      \
                                     (Source == TIM3_Break1Source_AWD) ||             \
                                     (Source == TIM3_Break1Source_IO))
// TIM3 OCREF_CLR
...
#define TIM15_Break1Source_TIM2_TRGO      ((uint32_t)0x00000800)
...
#define TIM16_Break1Source_TIM2_TRGO      ((uint32_t)0x00000800)
...
#define TIM17_Break1Source_TIM2_TRGO      ((uint32_t)0x08000000)
...
/* =========================================================  BDTR  ========================================================== */
#define TIM1_BDTR_TRIGOC_Pos (27UL)         /*!< TRIGOC (Bit 27)                                */
#define TIM1_BDTR_TRIGOC_Msk (0x8000000UL)  /*!< TRIGOC (Bitfield-Mask: 0x01)                   */
