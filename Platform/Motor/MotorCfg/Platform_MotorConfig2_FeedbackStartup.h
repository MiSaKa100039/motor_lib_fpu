...
inline void ApplyFeedbackAndStartupConfig(Lib_Motor::MotorConfig& cfg)
{
    ...
    cfg.position.rotor_feedback.feedback_class = Lib_Motor::AngleFeedbackClass::HALL_SECTOR;
    ...
    */
    cfg.default_run_policy.startup_source = Lib_Motor::StartupSource::HFI;
     ...
     *         顺逆风启动检测。
     *
     * 本工程 startup_source=HFI 但顺逆风启动 DISABLED, 因此仍需明确静止保证
