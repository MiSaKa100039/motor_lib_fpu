...
volatile Lib_Motor::MotorVFStartupPhase Platform_TestVFStartupPhases[] = {
    {0.50f,   400.0f, 0.03f},
    {0.50f, 1000.0f, 0.060f},
    {1.00f, 1800.0f, 0.100f},
    {1.00f, 2500.0f, 0.150f},
    {1.00f, 3000.0f, 0.160f},
};
#endif
...
volatile Lib_Motor::MotorIFStartupPhase Platform_TestIFStartupPhases[] = {
    {2.00f,   200.0f, 0.00f, 2.00f},
    {2.00f,  400.0f, 0.00f, 2.00f},
    {2.00f, 1500.0f, 0.00f, 4.00f},
